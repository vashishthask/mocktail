...
public class MocktailAspectsCreator {
    ...
    public void createRecordingAspects(List<Mocktail> mocktails, File aspectsDirectory) {
        createAspects(mocktails, aspectsDirectory, MocktailMode.RECORDING);

    }

    public void createPlaybackAspects(List<Mocktail> mocktails, File aspectsDirectory) {
    ...
    private void createAspects(List<Mocktail> mocktailsForAspects, File aspectsDirectory, MocktailMode mocktailMode) {
    ...
    private void createAspect(Mocktail mocktail, File aspectsRootDirectory, AspectType aspectType,
