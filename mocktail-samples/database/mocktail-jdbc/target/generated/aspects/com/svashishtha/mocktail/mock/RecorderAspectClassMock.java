...
public aspect RecorderAspectClassMock {
	...
	pointcut callPointcut() : call(* com.svashishtha.mocktail.mock.ClassMock.*(..));
	
	
	Object around() : callPointcut() {
		
		String fqcn = "com.svashishtha.mocktail.mock.ClassMock";
		String fileSeparator = File.separator;
		
		String recordingDirectoryPath = "/Users/shrikant/code/github/mocktail/mocktail-samples/database/mocktail-jdbc/target/generated/recordings" + fileSeparator + fqcn.replaceAll("\\.", fileSeparator);
