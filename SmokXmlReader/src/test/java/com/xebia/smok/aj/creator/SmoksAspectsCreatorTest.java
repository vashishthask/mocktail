...
public class SmoksAspectsCreatorTest {
	...
	public void testCreateAspects() throws Exception {
		...
		String testAspectsDirectory = absolutePath("src", "test",
		...
		String firstSmokFile = absolutePath("src", "test", "resources",
				"com", "xebia", "smok", "aspectsDirectory", "com", "xebia",
				"smok", "aj", "creator", "AspectTemplateProcesser.aj");
		assertTrue(new File(firstSmokFile).isFile());

		String secondSmokFile = absolutePath("src", "test", "resources",
				"com", "xebia", "smok", "aspectsDirectory", "com", "xebia",
				"smok", "xml", "domain", "AspectSmok.aj");
