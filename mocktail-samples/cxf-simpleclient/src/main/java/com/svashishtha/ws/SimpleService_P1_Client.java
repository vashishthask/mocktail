...
public final class SimpleService_P1_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        TCPMon tcpMon = new TCPMon(1234, "127.0.0.1", 8080, SimpleService_Service.class.getName() , "main", MocktailMode.RECORDING_NEW);
        ...
        for (String key : keySet) {
            System.out.println("The key:"+key + " the value is:"+context.get(key));
        }
