...
public enum MocktailAspectsCreator {
	...
	public int createAspects(List<Mocktail> mocktailsForAspects, File aspectsDirectory, MocktailMode mocktailMode) {
		int aspectsCreated = 0;
		AspectCreator<Mocktail> mocktailAspectCreator;
		for (Mocktail mocktail : mocktailsForAspects) {
			mocktailAspectCreator = MocktailAspectCreatorFactory.getAspectCreator(mocktail.onlyForClass(), mocktailMode);
			try {
